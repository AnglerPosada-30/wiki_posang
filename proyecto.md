...
![Imagen de la ejecución del comando mkdir para crear la carpeta que contendra todo el proyecto](img/img_proyecto/creacion.png)
...
![Verificación de funcionamiento actualizado de Node y del gestor de paquete npm ](img/img_proyecto/verficacionActualizado.png)
...
![Instalación de dependencias 1 ](img/img_proyecto/dependencias.png)

![Página web base activa ](img/img_proyecto/servidorActivo.png)
